...
public class TicTacToeServerImpl extends UnicastRemoteObject implements TicTacToeClient {
    private TicTacToeServer server;
    private char[][] board = new char[3][3];

    public TicTacToeServerImpl(TicTacToeServer server) throws RemoteException {
        super();
        this.server = server;
